...
class Ps5BigW {
  ...
  scan() {
    axios
      .get("https://api.bigw.com.au/api/products/v0/product/124625")
      .then((res) => {
          ...
          if (!this.wasFound) {
            ...
            this.client.channels
              ...
              .then((channel) => {
                if (channel)
                  channel.send(
                    `<@&${this.roleId}> Please know that a Disc PS5 is available at: https://www.bigw.com.au/product/playstation-5-console/p/124625`,
                  );
              })
    ...
    axios
      .get("https://api.bigw.com.au/api/products/v0/product/124626")
      .then((res) => {
          ...
          if (!this.wasFound2) {
            ...
            this.client.channels
              ...
              .then((channel) => {
                if (channel)
                  channel.send(
                    `<@&${this.roleId}> Please know that a Digital PS5 is available at: https://www.bigw.com.au/product/playstation-5-console/p/124626`,
                  );
              })
              .catch((e) => console.error(e));
          }
