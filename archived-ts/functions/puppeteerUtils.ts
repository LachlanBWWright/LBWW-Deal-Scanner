...
export async function getPageTitleSafely(page: Page) {
  return resultAsync(() => page.title(), "Failed to get page title");
}
...
export async function closePageSafely(page: Page) {
  return resultAsync(() => page.close(), "Failed to close page");
}

export async function createNewPageSafely(browser: Browser) {
  return resultAsync(() => browser.newPage(), "Failed to create new page");
}
